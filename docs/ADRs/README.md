# ADRs — Registros de Decisões Arquiteturais (THZ-LANG)

Registros de decisões arquiteturais imutáveis. Cada ADR explica contexto, decisão e consequências.

| ADR | Título | Status |
| :--- | :--- | :--- |
| [ADR-001](ADR-001-llvm-vs-cranelift.md) | LLVM vs Cranelift/QBE para AOT | Aceito |
| [ADR-002](ADR-002-arena-vs-gc.md) | Arena O(1) vs GC para lotes | Aceito |
