...
$DriverThz = if (Test-Path "$Raiz\..\thz-compiler\driver.thz") { "$Raiz\..\thz-compiler\driver.thz" } else { "$Raiz\compilador\driver.thz" }
& "$PSScriptRoot\build-llvm.ps1" -ArquivoThz $DriverThz -Alvo windows
