...
$pkgScript = if (Test-Path "$Raiz\..\thz-cli-jvm\scripts\build-package.ps1") { "$Raiz\..\thz-cli-jvm\scripts\build-package.ps1" } else { "$Raiz\JVM\thz-cli-jvm\scripts\build-package.ps1" }
& $pkgScript @pkgArgs
