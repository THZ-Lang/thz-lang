...
- Adicionar ao mapa em `thz-lang-engine-JVM25/src/main/java/thz/lang/lexico/PalavrasReservadas.java`.
...
- Criar a classe/record Java correspondente em `thz-lang-engine-JVM25/src/main/java/thz/lang/ast/`.
...
2. `mvn test` em `thz-lang-engine-JVM25` (29+ testes verdes).
