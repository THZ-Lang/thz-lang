# ==============================================================================
# THZ-LANG — Multi-Stage Dockerfile / Containerfile
# Suporta: Docker, Podman, Compose e Devcontainers
# Base: Eclipse Temurin JDK 25 (Ubuntu Noble 24.04) + LLVM/Clang + Node.js 20
# ==============================================================================
